      ...
      <div className="flex w-full gap-1 h-[calc(100vh-120px)] shrink-0">
        ...
        <div className="w-[320px] bg-white dark:bg-[#121216] border-l border-slate-200 dark:border-[#1e1e24] flex flex-col overflow-y-auto shrink-0 p-3">
          ...
          <div className="flex justify-between items-center text-xs font-semibold mb-3 px-1">
            <span className="text-slate-500">Avbl <span className="text-slate-900 dark:text-white">{Math.max(0, balances.vaultUSDC - positions.reduce((acc, pos) => acc + pos.margin, 0)).toLocaleString(undefined, { minimumFractionDigits: 2 })} USDT</span></span>
