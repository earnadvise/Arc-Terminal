        ...
        <div className="w-[320px] bg-[#121216] border-l border-[#1e1e24] flex flex-col overflow-y-auto shrink-0 p-3">
          ...
          <div className="flex justify-between items-center text-xs font-semibold mb-3 px-1">
            ...
            <div className="flex items-center gap-2">
              <button className="text-[#e5c07b] hover:text-white transition-colors" title="Withdraw" onClick={() => withdrawFunds(1000)}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/></svg></button>
