...
export default function BuyView() {
  ...
  const [paymentMethod, setPaymentMethod] = useState<'card' | 'applepay'>('applepay');
  ...
  const handleBuy = () => {
    ...
    addNotification('info', 'Processing Payment', `Initiating secure checkout with ${paymentMethod === 'applepay' ? 'Apple Pay' : 'Credit Card'}...`);
